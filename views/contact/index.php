    ...
    <main>
        <article class="globalContact">
            <div>
                ...
                <p>Remplissez le formulaire ci-dessous afin que nous puissions échanger sur vos besoins et vous proposer
                    la
            ...
            <div class="contactSection">
                <div class="infoContact">
                    ...
                    <p id="textIntervention">*Intervention sur l'ensemble du département du Lot</p>
                </div>
                ...
                <form id="contactForm" action="/contact/send" method="POST" novalidate>
                    <fieldset class="form">
                        ...
                        <div class="messageSuccess close">
                            ...
                            <p id="successText"> Votre message a été envoyé avec succès &#x2713; </br> Je prends
                                connaissance de votre
                                demande et reviens vers vous dans les plus brefs délais. </p>
                        </div>

                        <div class="messageFail close">
                            <span class="closeButtonFail">&times;</span>
                            <p id="failText"> <strong>Erreur !</strong> Nous n'avons pas pu enregistrer votre message.
                            </p>
                        </div>


                        <label>
                            <span class="labelTitle"> Nom <span class="required">*</span>
                            </span>
                            <input required aria-required="true" type="text" name="name" minlength="2" maxlength="40"
                        ...
                        <label> Tél
                            <input type="tel" name="tel" placeholder="06 12 24 48 96" minlength="10" maxlength="20">
                        </label>

                        <label>
                            <span class="labelTitle">Email <span class="required">*</span>
                            </span>
                            <input type="email" name="email" minlength="6" maxlength="60"
                                placeholder="exemple@gmail.com">
                        </label>

                        <label> <span class="labelTitle">Message <span class="required">*</span>
                            </span>
                            <textarea name="message" rows="8" cols="70" minlength="10" maxlength="1000" placeholder="Bonjour,
...
Cordialement."></textarea>
                        ...
                        <div class="checkboxCgu">
                            ...
                            <label for="cgu">J'ai pris connaissance de la <a href="">Politique de confidentialité</a> et
                                j'accepte le traitement de mes données personnelles</label>
                        </div>
